...
@font-face {
  font-family: "Ericsson Icons";
  src: url("../font/icons/ericsson-icons.eot?mvqo1v");
  src: url("../font/icons/ericsson-icons.eot?mvqo1v#iefix") format("embedded-opentype"), url("../font/icons/ericsson-icons.ttf?mvqo1v") format("truetype"), url("../font/icons/ericsson-icons.woff?mvqo1v") format("woff"), url("../font/icons/ericsson-icons.svg?mvqo1v#ericsson-icons") format("svg");
  font-style: normal;
}
