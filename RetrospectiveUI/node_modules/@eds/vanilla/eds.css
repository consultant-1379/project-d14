...
.dark .chart .axis.bottom .tick:first-of-type text {
  text-anchor: start;
}
.dark .chart .axis.bottom .tick:last-of-type text {
  text-anchor: end;
}
...
.dark .chart .axis .tick text {
  fill: #f2f2f2;
  font-family: "Ericsson Hilda", "Helvetica", "sans-serif";
}
.dark .chart .axis .tick text.green {
  fill: #288964;
}
.dark .chart .axis .tick text.yellow {
  fill: #dcaf00;
}
.dark .chart .axis .tick text.orange {
  fill: #e66e19;
}
.dark .chart .axis .tick text.red {
  fill: #dc2d37;
}
.dark .bar-chart .bar .line {
  stroke: #f2f2f2;
}
.dark .bar-chart .bar .line.active {
  opacity: 1;
}
.dark .bar-chart .bar .line.inactive {
  opacity: 0.2;
}
.dark .bar-chart .bar .line.green {
  stroke: #288964;
}
.dark .bar-chart .bar .line.yellow {
  stroke: #dcaf00;
}
.dark .bar-chart .bar .line.orange {
  stroke: #e66e19;
}
.dark .bar-chart .bar .line.red {
  stroke: #dc2d37;
}
.dark .bar-chart .bar .label {
  display: block;
  fill: #f2f2f2;
}
.dark .bar-chart .bar .label.value {
  font-weight: 500;
}
.dark .bar-chart .bar .label.active {
  opacity: 1;
}
.dark .bar-chart .bar .label.inactive {
  opacity: 0.2;
}
.dark .bar-chart .bar .label.hidden {
  opacity: 0;
}
.dark .bar-chart .bar .label.visible {
  opacity: 1;
}
...
.dark .accordion li ol li,
.dark .accordion li ul li {
  padding: 4px 0;
}
...
.dark .slider input[type="range"]::-ms-fill-lower {
  background: #f2f2f2;
  border-radius: 10px;
}
.dark .slider input[type="range"]::-ms-fill-upper {
  background: #f2f2f2;
  border-radius: 10px;
}
...
.dark .slider input[type="range"]::-moz-range-thumb:hover {
  background: #0082f0;
}
...
.dark .slider input[type="range"]::-ms-thumb:hover {
  background: #0082f0;
}
.dark .slider input[type="range"]::-ms-tooltip {
  display: none;
}
.dark .slider input[type="range"]:focus:hover::-webkit-slider-thumb {
  background: #0082f0;
}
.dark .slider input[type="range"]:focus:hover::-moz-range-thumb {
  background: #0082f0;
}
.dark .slider input[type="range"]:focus:hover::-ms-thumb {
  background: #0082f0;
}
.dark .notification {
  position: absolute;
...
.dark .notification-log-trigger.item {
  background-image: -webkit-gradient(linear, right top, left top, color-stop(50%, #0082f0), color-stop(50%, transparent));
  background-image: linear-gradient(to left, #0082f0 50%, transparent 50%);
...
.light .chart .axis.bottom .tick:first-of-type text {
  text-anchor: start;
}
.light .chart .axis.bottom .tick:last-of-type text {
  text-anchor: end;
}
...
.light .chart .axis .tick text {
  fill: #4e4e4e;
  font-family: "Ericsson Hilda", "Helvetica", "sans-serif";
}
.light .chart .axis .tick text.green {
  fill: #34b07f;
}
.light .chart .axis .tick text.yellow {
  fill: #f2c618;
}
.light .chart .axis .tick text.orange {
  fill: #f78521;
}
.light .chart .axis .tick text.red {
  fill: #f52323;
}
.light .bar-chart .bar .line {
  stroke: #4e4e4e;
}
.light .bar-chart .bar .line.active {
  opacity: 1;
}
.light .bar-chart .bar .line.inactive {
  opacity: 0.2;
}
.light .bar-chart .bar .line.green {
  stroke: #34b07f;
}
.light .bar-chart .bar .line.yellow {
  stroke: #f2c618;
}
.light .bar-chart .bar .line.orange {
  stroke: #f78521;
}
.light .bar-chart .bar .line.red {
  stroke: #f52323;
}
.light .bar-chart .bar .label {
  display: block;
  fill: #4e4e4e;
}
.light .bar-chart .bar .label.value {
  font-weight: 700;
}
.light .bar-chart .bar .label.active {
  opacity: 1;
}
.light .bar-chart .bar .label.inactive {
  opacity: 0.2;
}
.light .bar-chart .bar .label.hidden {
  opacity: 0;
}
.light .bar-chart .bar .label.visible {
  opacity: 1;
}
...
.light .accordion li ol li,
.light .accordion li ul li {
  padding: 4px 0;
}
...
.light .slider input[type="range"]::-ms-fill-lower {
  background: #d4d4d4;
  border-radius: 10px;
}
.light .slider input[type="range"]::-ms-fill-upper {
  background: #d4d4d4;
  border-radius: 10px;
}
...
.light .slider input[type="range"]::-moz-range-thumb:hover {
  background: #0082f0;
}
...
.light .slider input[type="range"]::-ms-thumb:hover {
  background: #0082f0;
}
.light .slider input[type="range"]::-ms-tooltip {
  display: none;
}
.light .slider input[type="range"]:focus:hover::-webkit-slider-thumb {
  background: #0082f0;
}
.light .slider input[type="range"]:focus:hover::-moz-range-thumb {
  background: #0082f0;
}
.light .slider input[type="range"]:focus:hover::-ms-thumb {
  background: #0082f0;
}
.light .notification {
  position: absolute;
