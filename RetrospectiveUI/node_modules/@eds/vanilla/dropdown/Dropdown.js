...
export class Dropdown {
  ...
  removeEventListeners() {
    switch (this.type) {
      case 'click':
        ...
        this.dom.menu.removeEventListener('click', () => this.menu.hide());
        break;
      case 'single':
    ...
    this.ifClickedOutside(() => this.menu.hide(), 'remove');
  }
  ...
  addEventListeners() {
    ...
    this.ifClickedOutside(() => this.menu.hide(), 'add');
  }
   ...
   */
  ifClickedOutside(callback, type) {
    if (type === 'remove') {
