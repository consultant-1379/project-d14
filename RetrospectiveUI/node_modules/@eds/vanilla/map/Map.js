...
export class Map {
  ...
  removeEventListeners() {
    document.removeEventListener('maximizeTile', () => {
      setTimeout(() => {
        this.map.resize();
        this.map.flyTo({ center: this.mapCenter });
      }, 600);
    ...
    document.removeEventListener('minimizeTile', () => {
      setTimeout(() => {
        this.map.resize();
        this.map.flyTo({ center: this.mapCenter });
      }, 600);
    ...
    document.removeEventListener('toggleNavigation', () => {
      setTimeout(() => {
        this.map.resize();
        this.map.flyTo({ center: this.mapCenter });
      }, 600);
    ...
    document.removeEventListener('switchTheme', (event) => {
      this.loadedTheme = event.detail.theme;
      this.map.setStyle('mapbox://styles/' + this.themes[this.loadedTheme]);
      this.map.on('style.load', () => {
        this.lines.paint['line-color'] = this.lineColors[this.loadedTheme];
