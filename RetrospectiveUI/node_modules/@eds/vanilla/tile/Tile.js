export class Tile {
  ...
  removeEventListeners() {
    ...
    if (actions) {
      Array.from(actions).forEach(action => {
        if (action.dataset.type === 'maximize') {
          action.removeEventListener('click', () => this.toggleFullScreen(action), false);
        }
      });
    }
    this.dom.tile.removeEventListener('maximizeTile', (e) => this.hideNotSelf(e), false);
    this.dom.tile.removeEventListener('minimizeTile', () => this.show(), false);
  }
